...
with open("output.txt", "w") as output_file:
	for index in range(0, len(test_lines)):
		# EN
		prob_en = utilities.cal_lang_char_prob(en_basic_ngram_prob, en_basic_ngram_count, n, test_lines[index])
		# FR
		prob_fr = utilities.cal_lang_char_prob(fr_basic_ngram_prob, fr_basic_ngram_count, n, test_lines[index])
		# VI
		prob_vi = utilities.cal_lang_char_prob(vi_basic_ngram_prob, vi_basic_ngram_count, n, test_lines[index])
...
if n == 1 or n == 2:
	utilities.dump_models(en_basic_ngram_count, fr_basic_ngram_count, vi_basic_ngram_count, n)
